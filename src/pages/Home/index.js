...
const Home = () => (
  <div id="home">
    <div className="home-wrapper">
      <PageHeader
        image={(<img src={imageLogo} alt="" />)}
        headerItems={(
          <>
            <strong className="profile-name">Xostaker</strong>
            <p className="profile-tweets">6 Tweets</p>
          </>
        )}
      />
      <div className="profile">
        ...
        <div className="tweets">
          {tweetsData.tweets.map((t, i) => <p key={i}>{t.tweet}</p>)}
        </div>
      </div>
      <div className="tweets" />
    </div>
